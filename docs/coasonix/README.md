...
10. [../../schemas/coagent-v1.schema.json](../../schemas/coagent-v1.schema.json) - Current test contract fixture

## Document Layers

| Layer | Document | Purpose |
|---|---|---|
| Product model | [00-collaboration-model.md](00-collaboration-model.md) | Codex / Coagent / Reasonix decision chain |
...
| Runtime (implemented) | [02-runtime/](02-runtime) | Coagent internal safety gates |
